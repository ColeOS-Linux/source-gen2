...
<p> this also includes gnome addition(currently broken, we will fix it as soon as possible), along with a script that builds both , to build, go into the xfce dir and run sudo sh steps.sh</p>
